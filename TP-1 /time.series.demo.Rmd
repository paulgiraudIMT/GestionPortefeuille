...
```{r, fig-2, echo=FALSE, fig.width=10, fig.cap="Air liquide"}
plot(ts.air, main='Air liquide')
```
...
```{r, echo=TRUE, cache=TRUE}
cor.EU = cor(ts.EuroStoxx50)
corrplot::corrplot(cor.EU, type='upper', order ='hclust', tl.pos = 'n')
```
