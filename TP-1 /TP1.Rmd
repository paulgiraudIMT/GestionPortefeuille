...
```{r, correlation, warning=FALSE, echo=TRUE} 
cov.all <- cor(ts.all)
cov.all[lower.tri(cov.all)] <- NA
options(knitr.kable.NA = '')
kable(cov.all, "latex", booktabs=T, digits=2, caption="Corrélation des rendements") %>%
kable_styling(latex_options="scale_down")
corrplot::corrplot(cov.all, type='upper', tl.pos = 'n', order = 'hclust')
```
